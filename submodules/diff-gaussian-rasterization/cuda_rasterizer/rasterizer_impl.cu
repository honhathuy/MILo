...
int CudaRasterizer::Rasterizer::forward(
	...
	const int width, int height, const int num_classes, const int n_features,
	const float* means3D,
	const float* shs,
	...
	)
{
	...
	CHECK_CUDA(FORWARD::render(
		...
		width, height, num_classes, n_features,
...
void CudaRasterizer::Rasterizer::backward(
	const int P, const int num_classes, const int n_features, int D, int M, int R,
	const float* background,
	...
	const float* dL_dpix_gaussian_features,
	...
	bool debug)
{
	...
	CHECK_CUDA(BACKWARD::render(
		...
		imgState.ranges,
		binningState.point_list,
		num_classes, n_features, width, height,
		background,
		geomState.view_points,
		geomState.means2D,
		geomState.conic_opacity,
